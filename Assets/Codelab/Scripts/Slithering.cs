...
public class Slithering : MonoBehaviour 
{
    ...
    //<Transform> = for positioning bodyparts dynamically
    private List<Transform> bodyParts = new List<Transform>();

    //This is called property(getter and setter)
    //SnakeController - 91
